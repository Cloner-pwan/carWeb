        ...
        <header>
            ...
            <div class="headerBottom">
                ...
                <div class="itemsContainer">
                    ...
                    <div class="items">
                        <a href="../php/adminList.php">لیست ادمین ها</a>
                    </div>
                    <div class="items">
                        <a href="../php/productRegistration.php">ثبت کالای جدید</a>
                    </div>
                    <div class="items">
                        <a href="../php/deleteProductsPage.php">حذف کالا</a>
                    </div>
                </div>
            </div>
        </header>
        ...
        <div class="productsBoxContainer">
            ...
            while ($row = mysqli_fetch_array($result)) {
                echo "<div class='productBox'>
                  ...
                  <form action='shoppingAdmin.php' method='POST'>
                  <input type='hidden' name='pro_code' value='" . $row['pro_code'] . "'/>
                  <button class='showbtn'>نمایش</button>
                  </form>";
